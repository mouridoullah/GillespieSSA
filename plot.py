...
plt.plot(time, b, label='C', c='150')
plt.plot(time, c, label='N', c='green')
plt.plot(time, d, label='O', c='black')
plt.plot(time, e, label='Br', c='yellow')
plt.plot(time, f, label='I', c='010')
plt.plot(time, g, label='Cl', c='030')
plt.plot(time, h, label='H2O2', c='pink')
plt.plot(time, i, label='H2', c='orange')
...
plt.plot(time, q, label='CO2', c='140')
plt.plot(time, r, label='CO', c='brown')
plt.plot(time, s, label='CH4', c='beige')
plt.plot(time, t, label='C6H6', c='170')
plt.plot(time, u, label='C4H10', c='200')
